...
const UtsavaMurthySchema: Schema = new Schema({
...
const options = {
    modelName: 'UtsavaMurthy',
    field: 'utsavaMurthyNumber', // user_id will have an auto-incrementing value
};

UtsavaMurthySchema.plugin(MongooseAutoIncrementID.plugin, options);

export default model("UtsavaMurthy", UtsavaMurthySchema);
