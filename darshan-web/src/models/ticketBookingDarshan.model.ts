...
const TicketBookingDarshanSchema: Schema = new Schema({
...
const options = {
  modelName: 'TicketBookingDarshan',
  field: 'bookingNumber', // user_id will have an auto-incrementing value
};

TicketBookingDarshanSchema.plugin(MongooseAutoIncrementID.plugin, options);

export default model("TicketBookingDarshan", TicketBookingDarshanSchema);
