...
const SpecialPoojaSchema: Schema = new Schema({
...
const options = {
    modelName: 'SpecialPooja',
    field: 'SpecialPoojaNumber', // user_id will have an auto-incrementing value
};

SpecialPoojaSchema.plugin(MongooseAutoIncrementID.plugin, options);

export default model("SpecialPooja", SpecialPoojaSchema);
