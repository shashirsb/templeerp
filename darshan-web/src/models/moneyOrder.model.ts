...
const MoneyOrderSchema: Schema = new Schema({
...
const options = {
    modelName: 'MoneyOrder',
    field: 'moneyOrderNumber', // user_id will have an auto-incrementing value
};

MoneyOrderSchema.plugin(MongooseAutoIncrementID.plugin, options);

export default model("MoneyOrder", MoneyOrderSchema);
