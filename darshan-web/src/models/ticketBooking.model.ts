...
const TicketBookingSchema: Schema = new Schema({
...
TicketBookingSchema.plugin(MongooseAutoIncrementID.plugin, options);

export default model("TicketBooking", TicketBookingSchema);
